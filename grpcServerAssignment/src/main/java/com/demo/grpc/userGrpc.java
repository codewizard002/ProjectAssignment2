...
public final class userGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.demo.grpc.User.LoginRequest,
      com.demo.grpc.User.UserResponse> getRegisterUserMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "RegisterUser",
      requestType = com.demo.grpc.User.LoginRequest.class,
      responseType = com.demo.grpc.User.UserResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.demo.grpc.User.LoginRequest,
      com.demo.grpc.User.UserResponse> getRegisterUserMethod() {
    io.grpc.MethodDescriptor<com.demo.grpc.User.LoginRequest, com.demo.grpc.User.UserResponse> getRegisterUserMethod;
    if ((getRegisterUserMethod = userGrpc.getRegisterUserMethod) == null) {
      synchronized (userGrpc.class) {
        if ((getRegisterUserMethod = userGrpc.getRegisterUserMethod) == null) {
          userGrpc.getRegisterUserMethod = getRegisterUserMethod = 
              io.grpc.MethodDescriptor.<com.demo.grpc.User.LoginRequest, com.demo.grpc.User.UserResponse>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.demo.grpc.User.UserResponse.getDefaultInstance()))
  ...
  public static io.grpc.MethodDescriptor<com.demo.grpc.User.LoginRequest,
      com.demo.grpc.User.APIResponse> getLoginMethod() {
    io.grpc.MethodDescriptor<com.demo.grpc.User.LoginRequest, com.demo.grpc.User.APIResponse> getLoginMethod;
    if ((getLoginMethod = userGrpc.getLoginMethod) == null) {
      synchronized (userGrpc.class) {
        if ((getLoginMethod = userGrpc.getLoginMethod) == null) {
          userGrpc.getLoginMethod = getLoginMethod = 
              io.grpc.MethodDescriptor.<com.demo.grpc.User.LoginRequest, com.demo.grpc.User.APIResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "user", "login"))
              .setSampledToLocalTracing(true)
  ...
  public static abstract class userImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void registerUser(com.demo.grpc.User.LoginRequest request,
        io.grpc.stub.StreamObserver<com.demo.grpc.User.UserResponse> responseObserver) {
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ...
                com.demo.grpc.User.UserResponse>(
  ...
  public static final class userBlockingStub extends io.grpc.stub.AbstractStub<userBlockingStub> {
    ...
    /**
     */
    public com.demo.grpc.User.UserResponse registerUser(com.demo.grpc.User.LoginRequest request) {
    ...
    /**
     */
    public com.demo.grpc.User.APIResponse login(com.demo.grpc.User.LoginRequest request) {
      return blockingUnaryCall(
  ...
  public static final class userFutureStub extends io.grpc.stub.AbstractStub<userFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.demo.grpc.User.UserResponse> registerUser(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_REGISTER_USER:
          serviceImpl.registerUser((com.demo.grpc.User.LoginRequest) request,
              (io.grpc.stub.StreamObserver<com.demo.grpc.User.UserResponse>) responseObserver);
          break;
        case METHODID_LOGIN:
